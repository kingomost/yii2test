...
class OperationsTipRun extends Model
{
	public $resalt_info = '';
	public $arr_info = [
							0 => 'Перевод больше, чем на счету',
							1 => 'Тут ошибка при записи ID операций, надо перехватывать исключениями, не дойдет до сюда - fatal',
							2 => 'Операция Send успешно выполнена.',
							3 => 'Операция Pin успешно выполнена.',
							4 => 'Большая сумма для перевода за раз.',
							5 => 'Операция Ask успешно выполнена.',
							6 => 'Операции с самим собой не выполняются.',
							7 => 'Такого пользователя нет в системе.',
					];
